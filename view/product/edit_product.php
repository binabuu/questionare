...
<div class="w3-row-padding">
  ...
  <input class="w3-input w3-border w3-light-grey" name="bp" id="bp" type="text" value="<?php echo $this->edit['buyprice']?>">
  </div>
 <div class="w3-half">
   <label class="w3-text-teal"><b>Sell Price</b></label>
  <input class="w3-input w3-border w3-light-grey" name="sp" id="sp" type="text" value="<?php echo $this->edit['sellprice']?>">
  </div>
</div>
</p>
