...
<div class="w3-row-padding">
  <div class="w3-half">
  <input class="w3-input w3-border w3-light-grey" name="sd" id="sd" type="date" placeholder="Search by Customer Name">
  </div>
  
   <div class="w3-half">
  <input class="w3-input w3-border w3-light-grey" name="ed" id="ed" type="date" placeholder="Search by Product Name">
  </div>
...
$(document).ready(function () {
	 var url = "<?php echo URL ?>home/stockin2";
    $.get(url, null, function (data) {
      ...
      $('#ed').change(function (){
		  ...
		  {
			  $.ajax({
				  url:"<?php echo URL ?>home/stockInSearch",
				  method:"POST",
				  data:{ed:txt,sd:sd,bname},
				  dataType:"text",
