...
<div class="w3-container w3-text-teal ">
  <h2 ><?php echo $this->cust2['supname']." (".$this->cust2['location'].") "?> Account</h2>
</div>
</p> 
<div class="w3-row-padding">
  <div class="w3-half">
  <input class="w3-input w3-border w3-light-grey" name="sd" id="sd" type="date" >
  <input class="w3-input w3-border w3-light-grey" name="custid" id="custid" type="hidden" value="<?php echo $this->cust2['supId']?>" >
  </div>
...
$(document).ready(function () {
	 var url = "<?php echo URL ?>supplier/statement/<?php echo $this->cust2['supId']?>";
    $.get(url, null, function (data) {
        ...
        $('#ed').change(function (){
		  ...
		  {
			  $.ajax({
				  url:"<?php echo URL ?>supplier/statementSearch",
				  method:"POST",
